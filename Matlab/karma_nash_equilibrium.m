...
for i_k_i = 1 : const.num_k
    ...
    for i_k_j = 1 : const.num_k
        k_j = const.k(i_k_j);
        const.k_next{i_k_i,i_k_j} = zeros(i_k_i, i_k_j);
        for i_m_i = 1 : i_k_i
            m_i = const.k(i_m_i);
            for i_m_j = 1 : i_k_j
                m_j = const.k(i_m_j);
                ...
                % 50/50 chances on equal bids
                else
                    const.k_next{i_k_i,i_k_j}(i_m_i,i_m_j) = floor(0.5 * (k_in + k_out));
                end
            end
        end
    end
                        ...
                        for i_k_j = 1 : const.num_k
                            ...
                            for i_m_j = 1 : i_k_j
                                ...
                                T(i_k_i,i_next_k_i) = T(i_k_i,i_next_k_i)...
                                    + p_u_i * p_m_i * p_u_j * p_k_j * p_m_j...
                                    * (const.k_next{i_k_i,i_k_j}(i_m_i,i_m_j) == const.k(i_next_k_i));
                            end
                        end
                    end
                end
            ...
            for u_j = [0, param.U]
                ...
                for i_k_j = 1 : const.num_k
                    ...
                    for i_m_j = 1 : i_k_j
                        ...
                        c_future = const.alpha * theta(const.k == k_next);
